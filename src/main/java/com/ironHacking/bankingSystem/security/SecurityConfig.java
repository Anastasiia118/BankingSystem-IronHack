package com.ironHacking.bankingSystem.security;


import com.ironHacking.bankingSystem.filters.CustomAuthenticationFilter;
import com.ironHacking.bankingSystem.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(GET, "/balance/{id}").hasAuthority("ROLE_ADMIN")
                .requestMatchers(POST, "/create/{accountType}/{id}").hasAuthority("ROLE_ADMIN")
